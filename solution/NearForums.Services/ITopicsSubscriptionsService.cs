...
namespace NearForums.Services
{
	public interface ITopicsSubscriptionsService
	{
		...
		/// </summary>
		List<Topic> GetTopics(Guid userId);
		/// <summary>
        ...
        int Remove(int topicId, Guid userId, Guid userGuid);
		/// <summary>
        ...
        void SendNotifications(Message message, Guid userId, string url, string unsubscribeUrl);
	}
}
