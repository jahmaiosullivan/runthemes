...
namespace NearForums.Services
{
	public class TopicsSubscriptionsService : ITopicsSubscriptionsService
	{
		...
		public int Remove(int topicId, Guid userId, Guid userGuid)
		{
        ...
        public List<Topic> GetTopics(Guid userId)
		{
			return _dataAccess.GetTopicsByUser(userId);
		}

        public void SendNotifications(Message message, Guid userId, string url, string unsubscribeUrl)
		{
