...
namespace NearForums.Web.Controllers.Helpers
{
	public static class SubscriptionHelper
	{
		...
		/// </summary>
        public static void Manage(bool subscribe, int topicId, Guid userId, Guid userGuid, SiteConfiguration config, ITopicsSubscriptionsService service)
		{
			if (!config.Notifications.Subscription.IsDefined)
			{
				return;
        ...
        public static bool IsUserSubscribed(int topicId, Guid userId, SiteConfiguration config, ITopicsSubscriptionsService service)
		{
			if (!config.Notifications.Subscription.IsDefined)
			{
				return false;
