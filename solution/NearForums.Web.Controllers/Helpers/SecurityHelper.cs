...
namespace NearForums.Web.Controllers.Helpers
{
	...
	public static class SecurityHelper
	{
		...
		/// </summary>
        public static Guid OpenIdFinishLogin(IAuthenticationResponse response, SessionWrapper session, IUsersService service, bool enableClaimsRequest)
		{
        ...
        public static Guid TryFinishMembershipLogin(HttpContextBase context, SessionWrapper session, MembershipProvider provider, IUsersService service)
		{
        ...
        public static Guid TryFinishMembershipLogin(SessionWrapper session, MembershipUser membershipUser, IUsersService service)
		{
