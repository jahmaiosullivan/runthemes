...
namespace NearForums.Web.Controllers
{
	public class ForumsController : BaseController
	{
		...
		[RequireAuthorization(UserRole.Moderator)]
		public ActionResult ListAllUnansweredTopics(int page)
		{
			var topics = _topicService.GetAllUnanswered(page * Config.UI.TopicsPerPage, Config.UI.TopicsPerPage);
			ViewData["TotalTopics"] = _topicService.GetUnansweredTopicCount();
			ViewData["Page"] = page;
