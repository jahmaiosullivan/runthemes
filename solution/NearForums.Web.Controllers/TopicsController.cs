	...
	public class TopicsController : BaseController
	{
		...
		public ActionResult Detail(int id, string name, string forum, int page)
		{
			...
			if (topic.Forum.ShortName != forum)
			{
				...
				return ResultHelper.MovedPermanentlyResult(this, new{action="Detail", controller="Topics", id=id, name=topic.ShortName, forum=topic.Forum.ShortName});
			}
		...
		/// <summary>
		/// Marks a topic as inappropriate
		/// </summary>
		/// <param name="topicId">Topic id</param>
		[HttpPost]
		public ActionResult Flag(int topicId, string forum)
		{
			bool flagged = _service.Flag(topicId, Request.UserHostAddress);
